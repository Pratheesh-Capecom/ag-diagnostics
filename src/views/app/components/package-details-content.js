      ...
      <>
                  ...
                  <Col xs={12} sm={12} md={12} lg={10}>
                    ...
                    <div className="pckge_include">
                      ...
                      <div className="pckge_details">
                        ...
                        <p>
                          Hemogram, Blood Sugar (Fasting), Lipid Profile (Maxi),
                          Liver Function Test, BUN, Creatinine, Uric Acid, FT3
                          FT4 TSH, Vitamin B12, Vitamin B12, 25 OH Vitamin D
                          &amp; Urine Routine.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="pckge_include">
                      ...
                      <div className="pckge_details">
                        ...
                        <ul className="list-style1">
                          <li className="ms-0">
                            Ideally 10-12 hrs fasting required (Min. 8-10 hrs
                            fasting).
                          </li>
                          <li className="ms-0">
                            Provide medication & clinical details.
                          </li>
                          <li className="ms-0">
                            Intake of caloric food, coffee/tea/milk or, diet
                            soda/gum strictly not allowed during fasting period.
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="pckge_include">
                      ...
                      <div className="pckge_details">
                        ...
                        <p>
                          Daily (Mon to Sat) :18:30 hrs with same day
                          reporting.*
                        </p>
                      </div>
                    </div>
        ...
        >
          <Container>
            <Row>
              <Col>
                <button onClick={this.toggleClass} className="btn-close">
                  <GrClose />
                </button>
