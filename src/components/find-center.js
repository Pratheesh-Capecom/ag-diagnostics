...
import findCenterImage from '../images/find-center.jpg';
import mapImage from '../images/map.png';
import { Link } from 'react-router-dom';

class findCenter extends Component {
                ...
                <Container>
                    <Row className="align-items-center">
                        ...
                        <Col xs={12} sm={12} md={12} lg={4}>
                            <img src={findCenterImage} alt="" className="mar-top-30 img-fluid mb-3 d-sm-block d-block d-md-block d-lg-none w-100" />
                        </Col>
                    </Row>
                </Container>
            </section>
