                    ...
                    <Container>
                        <Row className="justify-content-between">
                            ...
                            <Col xs={12} sm={12} md={12} lg={6}>
                                ...
                                <p className="text-dark">Dr Golwilkar recognised the need for Home Visit services way back in 1978 and  pioneered this concept in the city. He recognized that terminally ill patients, patients who cannot move due to injuries, differently-abled patients, pregnant women, senior citizens, and patients who live far from his set-up but trust his services, need home service facilities. He himself started doing home visits for blood collection. He has personally trained and motivated many of our home-visit phlebotomists.</p>
                                <p className="text-dark">Thus, home visit services are a sine qua non feature of our laboratory. May it be rain or sunshine or chilly winter morning, our expert home visit team members will offer courteous and prompt services across the city.</p>
                                <p className="text-dark">Dr Golwilkar had been serving society across all sectors including many hospitals, teaching institutions, medical colleges, research institutes and social organizations in Pune. Thus, his name has been recognised with ‘Trust’ by many families throughout generations for their diagnostic needs.</p>
                                <p className="text-dark">His legacy is now ably carried forward by his daughters - Dr Awanti Golwilkar Mehendale and Dr Vinanti Golwilkar Patankar. It can be said that pathology runs in their blood.</p>
                            </Col>
                        </Row>
                    </Container>
                </section>
