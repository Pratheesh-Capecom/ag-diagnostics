...
<div class="row mb-3">
    ...
    <div class="col-5">
        @if(isset($test))
            @if($test->photo)
            <img src="{{asset('/public/upload/testimonial/photo').'/'.$test->photo}}" alt="No image" id="image_tag" width="100" height="100">
            @endif
        @endif
    </div>
</div>
...
<div class="row mb-3 video_url">
    ...
    <div class="col-5">
        @if(isset($test))
            ...
            <img src="{{asset('/public/upload/testimonial/video_cover_image').'/'.$test->video_cover_image}}" alt="No image" id="image_tag" width="100" height="100">
            @endif
        @endif
    </div>
</div>
