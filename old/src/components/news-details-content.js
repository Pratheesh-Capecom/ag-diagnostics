...
import NewsDetailsImg1 from '../images/our-values-image1.jpg';
import NewsDetailsImg2 from '../images/our-values-image2.jpg';
import NewsDetailsImg3 from '../images/our-values-image3.jpg';
import NewsDetailsImg4 from '../images/our-values-image4.jpg';
import NewsDetailsImg5 from '../images/our-values-image5.jpg';
                    ...
                    <Row className="justify-content-center">
                        <Col xs={12} sm={12} md={12} lg={10} xl={8}>
                            <div className="mar-bot-30">
                                <a href={NewsDetailsImg2} className="booklet-download" data-fancybox="images-preview" data-thumbs='{"autoStart":true}'>
                                    <img className="d-block w-100" src={NewsDetailsImg2} alt="" />
                                </a>
                            </div>
                            <div className="d-none">
                                <a href={NewsDetailsImg1} className="booklet-download" data-fancybox="images-preview" data-thumbs={NewsDetailsImg1}>
                                    <img className="d-block w-100" src={NewsDetailsImg1} alt="" />
                                </a>
                                <a href={NewsDetailsImg3} className="booklet-download" data-fancybox="images-preview" data-thumbs={NewsDetailsImg3}>
                                    <img className="d-block w-100" src={NewsDetailsImg3} alt="" />
                                </a>
                                <a href={NewsDetailsImg4} className="booklet-download" data-fancybox="images-preview" data-thumbs={NewsDetailsImg4}>
                                    <img className="d-block w-100" src={NewsDetailsImg4} alt="" />
                                </a>
                                <a href={NewsDetailsImg5} className="booklet-download" data-fancybox="images-preview" data-thumbs={NewsDetailsImg5}>
                                    <img className="d-block w-100" src={NewsDetailsImg5} alt="" />
                                </a>
                            </div>
                            <h3 className="text-start mar-bot-20">AG Diagnostics invites Franchisees for its network of collection centers across Pune</h3>
