                    ...
                    <Container>
                        ...
                        <Row className="justify-content-between align-items-center">
                            ...
                            <Col xs={12} sm={12} md={8} lg={6}>
                                ...
                                <h5 className="text-dark">Our haematology & special haematology section offers state-of-the-art testing for routine as well as specialized tests.</h5>
                                <p className="text-dark">The wide spectrum of tests includes complete blood count for diagnosing anaemias, infections such as malaria & dengue, and cancers of the blood to mention a few. A highly specialised set-up is available to evaluate bleeding and coagulation disorders and to monitor anticoagulation therapies. An automated blood group analyser ensures the detection of rare blood groups. Flow cytometry and electrophoresis are other high-end tests offered at A.G Diagnostics Pvt. Ltd. Bone marrow aspiration & bone marrow biopsy are tests which require a great degree of expertise. A.G Diagnostics has a large team of highly qualified and experienced technologists and a team of doctors working in this department, providing world-class services.</p>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                        ...
                        <Row className="justify-content-between align-items-center">
                            ...
                            <Col xs={12} sm={12} md={8} lg={6}>
                                ...
                                <h5 className="text-dark">A.G Diagnostics Pvt. Ltd. is committed to getting every test right the first time, every time and in the shortest time. To ensure this, the laboratory follows stringent quality control procedures & participates in multiple proficiency testing programs.</h5>
