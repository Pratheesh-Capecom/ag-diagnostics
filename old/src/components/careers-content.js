                    ...
                    <Container>
                        <Row className="align-items-center">
                            <Col xs={12} sm={12} md={12} lg={7}>
                                <h3 className="text-start text-white fw-normal">Become a part of a diagnostic company that’s a part of everything</h3>
                                <h5 className="text-white fw-normal mb-0">Ready to take the first step and embark on the journey to a rewarding role?</h5>
                            </Col>
