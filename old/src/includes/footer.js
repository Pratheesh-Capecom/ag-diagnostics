...
import BloodTestIcon from '../images/blood-test-icon.png';
import CovidIcon from '../images/covid-icon.png';
            ...
            <>            
                <footer>
                    <Container>
                        <Row className="justify-content-between">
                            <Col xs={12} sm={6} md={6} lg={4} xl={4}>
                                ...
                                <p className="icons">
                                    <Icon.Envelope /><Link onClick={() => openInNewTab('mailto:info@agdiagnostics.com')} className="text-white" >info@agdiagnostics.com</Link>
                                </p>	
                                <ul className="footer-socials">
                                    ...
                                    <li>
                                        <Link to="/" ><Icon.Instagram /></Link>
                                    </li>
                                    <li>
                                        <Link to="/" ><Icon.Twitter /></Link>
                                    </li>
                                    <li>
                                        <Link to="/" ><Icon.Youtube /></Link>
                                    </li>
                                    <li>
                    ...
                    <div className="footer-call-no">
                        <p>For Home Collection, call us at<br /><b>020 6763 6763</b></p>
                    </div>
                </footer>
                    ...
                    <Container>
                        <Row>
                            <Col className="footer-copyright pb-3">
                                <div className="text-white footer-bottom-text text-center">Copyright &copy; 2022. A.G Diagnostics Pvt. Ltd. | All Rights Reserved. Design By <Link to="https://www.pixel-studios.com/" target="_blank" className="text-white">Pixel Studios</Link></div>
                            </Col>
                        </Row>
                    </Container>
                </section>
                <ul className="right-fixed">
                    <li>
                        <Link to="/packages/"><BiTestTube /><span>Packages</span></Link>
                    </li>
                    <li>
                        <Link to="/home-visit/"><img src={BloodTestIcon} alt="" /><span>Book Home Visit</span></Link>
                    </li>
                    <li>
                        <Link to="/covid-pcr/"><img src={CovidIcon} alt="" /><span>Covid 19 PCR</span></Link>
                    </li>
                    <li>
                        <Link to="/"><BiDownload /><span>Download Report</span></Link>
                    </li>
                </ul>
            </>
        );
